...
Verify that `SPEC_CREATED` is present. If missing: ERROR "The spec does not exist yet. Run /product-flow:start-feature or /product-flow:start-improvement first."
